...
if (isset($_POST['update_rating'])) {
    ...
    // Update the rating in the database (you should have appropriate SQL query)
        ...
        <table class="product-display-table">
            ...
            <?php while ($row = mysqli_fetch_assoc($select)) { ?>
                <tr>
                    ...
                    <td>
                    <a href="UpdateProduct.php?edit=<?php echo $row['ProductID']; ?>" class="btn btn-edit">
        <i class="fas fa-edit"></i> Edit
    </a>
    <a href="DeleteProduct.php?delete=<?php echo $row['ProductID']; ?>" class="btn btn-delete">
